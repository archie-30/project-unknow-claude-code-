const Terrain = (() => {
  ...
  const groundPalette = {
    ...
    [BIOME.SNOW]: [c(0xa8b6c1), c(0x9dadba), c(0xb4c0c7)],
    [BIOME.LAKE]: [c(0xdccb9e), c(0xd4c192), c(0xe2d2a8)],
    [BIOME.SAVANNA]: [c(0xc9b67a), c(0xbca96e), c(0xd0bd86)],
    [BIOME.DESERT]: [c(0xd8b47c), c(0xcda86c), c(0xdfbf8c)],
  };
  const special = {
    seabed: c(0xbfae84),
    beach: c(0xdccb9e),
