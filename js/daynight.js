class TimeOfDay {
  constructor() {
    ...
    this.keys = [
      ...
      { t: 0.32, top: c(0x7cbde8), horizon: c(0xfde6c6), light: c(0xffe0b0), intensity: 0.72, hemiSky: c(0xcfe4f2), hemiGround: c(0xb8a98a), hemi: 0.5, cloud: c(0xfdf6ee) },
      { t: 0.5, top: c(0x6db6e6), horizon: c(0xe6e8e0), light: c(0xfff2d6), intensity: 0.8, hemiSky: c(0xd3e8f4), hemiGround: c(0xbcae90), hemi: 0.52, cloud: c(0xffffff) },
      { t: 0.66, top: c(0x70b3e2), horizon: c(0xf4e6cc), light: c(0xffdf9f), intensity: 0.74, hemiSky: c(0xd6e6ef), hemiGround: c(0xc2ad86), hemi: 0.5, cloud: c(0xfff8ec) },
